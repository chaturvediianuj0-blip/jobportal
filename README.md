...
### Week 3 summary
Maven, Nexus, and SonarQube were added to the CI/CD stack to strengthen build automation, artifact storage, and code quality enforcement.

### What comes next — Week 4
Docker and containerization, building the next layer in the DevOps pipeline.
